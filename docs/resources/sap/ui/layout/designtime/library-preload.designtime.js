 ...
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 */
sap.ui.predefine("sap/ui/layout/designtime/form/FormContainer.designtime",["sap/ui/fl/changeHandler/ChangeHandlerMediator","sap/ui/thirdparty/jquery","sap/ui/layout/form/Form"],function(e,t,n){"use strict";function r(e){return e.getFormElements().every(function(e){return e.getVisible()===false})}function i(e){if(e&&!(e instanceof n)){return i(e.getParent())}return e}function o(e){var t=i(e);if(t&&t.getLayout()&&t.getLayout().getMetadata().getName()==="sap.ui.layout.form.GridLayout"){return false}return true}return{palette:{group:"LAYOUT",icons:{svg:"sap/ui/layout/designtime/form/FormContainer.icon.svg"}},isVisible:function(e){return e.isVisible()},actions:{remove:function(e){if(o(e)){return{changeType:"hideControl"}}else{return null}},rename:function(e){if(o(e)){return{changeType:"renameGroup",domRef:function(e){if(!e.getRenderedDomRef()){var n=e.getTitle()||e.getToolbar();return n.getDomRef()}return t(e.getRenderedDomRef()).find(".sapUiFormTitle")[0]},isEnabled:function(e){return!(e.getToolbar()||!e.getTitle())}}}else{return null}}},aggregations:{formElements:{childNames:{singular:"FIELD_CONTROL_NAME",plural:"FIELD_CONTROL_NAME_PLURAL"},domRef:function(e){var n=e.getRenderedDomRef();var i=e.getTitle()||e.getToolbar();if(n){return n}if(e.getFormElements().length===0||r(e)){if(i instanceof sap.ui.core.Element){return i.getDomRef()}if(typeof i==="string"){return t(n).find(".sapUiFormTitle").get(0)}}return undefined},actions:{move:function(e){if(o(e)){return{changeType:"moveControls"}}else{return null}},addODataProperty:function(t){if(o(t)){var n=e.getAddODataFieldWithLabelSettings(t);if(n){return{changeType:"addFormField",changeOnRelevantContainer:true,changeHandlerSettings:n}}}else{return null}}}},toolbar:{domRef:function(e){var t=e.getToolbar();if(t){return t.getDomRef()}}}},name:{singular:"GROUP_CONTROL_NAME",plural:"GROUP_CONTROL_NAME_PLURAL"}}});
/*!
 * OpenUI5
 * (c) Copyright 2009-2020 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 */
sap.ui.predefine("sap/ui/layout/designtime/form/FormElement.designtime",["sap/ui/layout/form/Form","sap/ui/layout/form/FormContainer","sap/ui/layout/form/ResponsiveGridLayout"],function(e,t,n){"use strict";function r(t){if(t&&!(t instanceof e)){return r(t.getParent())}return t}function i(e){var t=r(e);if(t&&t.getLayout()&&t.getLayout().getMetadata().getName()==="sap.ui.layout.form.GridLayout"){return false}return true}return{palette:{group:"LAYOUT",icons:{svg:"sap/ui/layout/designtime/form/FormElement.icon.svg"}},isVisible:function(e){return e.isVisible()},domRef:function(r){var i=r.getParent();if(i instanceof t){i=i.getParent();if(i instanceof e){var o=i.getLayout();if(o instanceof n){var u=r.getFields();var a=r.getLabelControl();if(a){u.unshift(a)}return u.filter(function(e){return e.getDomRef&&e.getDomRef()}).map(function(e){var t=e.getDomRef();return t.parentNode})}}}},actions:{remove:function(e){if(i(e)){return{changeType:"hideControl"}}else{return null}},rename:function(e){if(i(e)){return{changeType:"renameField",domRef:function(e){return e.getLabelControl().getDomRef()}}}else{return null}},reveal:function(e){if(i(e)){return{changeType:"unhideControl"}}else{return null}}},name:{singular:"FIELD_CONTROL_NAME",plural:"FIELD_CONTROL_NAME_PLURAL"}}});
/*!
 * OpenUI5
 * (c) Copyright 2009-2020 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
